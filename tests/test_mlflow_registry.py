...
from src.models.mlflow_registry import artifact_log_name, registered_model_name
...
def test_artifact_log_name_strips_uc_prefix():
    assert artifact_log_name("main.default.cmapss_rul_gbm_FD001") == "cmapss_rul_gbm_FD001"
